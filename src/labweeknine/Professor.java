...
public class Professor extends TeachingStaff implements CanInstructCourses, CanConductResearch{

	public Professor(Person person, String registry_number, float salary) {
		super(person, registry_number, salary);
		// TODO Auto-generated constructor stub
	}

	public Professor(String identity_no, String name, String registry_number, float salary, CourseData[] courses) {
		super(identity_no, name, registry_number, salary, courses);
		// TODO Auto-generated constructor stub
	}

	public Professor(String identity_no, String name, String registry_number, float salary) {
