...
public class ResearchAssistant extends AssistingStaff implements CanAssistCourses, CanAssistLabCourses, CanOverseeExams {
	...
	public ResearchAssistant(Person person, String registry_number, float salary) {
		super(person, registry_number, salary);
		// TODO Auto-generated constructor stub
	}

	public ResearchAssistant(Person person, String registry_number, float salary, Lab lab) {
		super(person, registry_number, salary, lab);
		// TODO Auto-generated constructor stub
	}

	public ResearchAssistant(String identity_no, String name, String registry_number, float salary,
			CourseData[] courses) {
